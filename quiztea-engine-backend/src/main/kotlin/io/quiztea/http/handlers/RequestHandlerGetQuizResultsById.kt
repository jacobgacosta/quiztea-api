...
import io.quiztea.extensions.quiz.getQuizResults
import io.quiztea.http.executor

class RequestHandlerGetQuizResultsById : RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    override fun handleRequest(input: APIGatewayProxyRequestEvent?, context: Context?): APIGatewayProxyResponseEvent {
        val result: String = executor.call(getQuizResults, mapOf(
            "body" to (input?.body ?: ""),
