...
import io.quiztea.extensions.quiz.insertQuiz
import io.quiztea.http.executor

class RequestHandlerInsertQuiz : RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    override fun handleRequest(input: APIGatewayProxyRequestEvent?, context: Context?): APIGatewayProxyResponseEvent {
        val result: String = executor.call(insertQuiz, mapOf(
            "body" to (input?.body ?: ""),
