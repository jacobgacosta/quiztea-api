...
import io.quiztea.extensions.user.getUser
import io.quiztea.http.executor

class RequestHandlerGetUser : RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    override fun handleRequest(input: APIGatewayProxyRequestEvent?, context: Context?): APIGatewayProxyResponseEvent {
        val result: String = executor.call(getUser, mapOf(
            "body" to (input?.body ?: ""),
