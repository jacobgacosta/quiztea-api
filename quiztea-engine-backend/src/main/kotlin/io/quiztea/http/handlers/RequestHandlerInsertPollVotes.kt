...
import io.quiztea.extensions.poll.insertPollVotes
import io.quiztea.http.executor

class RequestHandlerInsertPollVotes : RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    override fun handleRequest(input: APIGatewayProxyRequestEvent?, context: Context?): APIGatewayProxyResponseEvent {
        val result: String = executor.call(insertPollVotes, mapOf(
            "body" to (input?.body ?: ""),
