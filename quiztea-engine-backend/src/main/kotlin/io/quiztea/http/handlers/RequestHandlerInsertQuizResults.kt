...
import io.quiztea.extensions.quiz.insertQuizResults
import io.quiztea.http.executor

class RequestHandlerInsertQuizResults : RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    override fun handleRequest(input: APIGatewayProxyRequestEvent?, context: Context?): APIGatewayProxyResponseEvent {
        val result: String = executor.call(insertQuizResults, mapOf(
            "body" to (input?.body ?: ""),
