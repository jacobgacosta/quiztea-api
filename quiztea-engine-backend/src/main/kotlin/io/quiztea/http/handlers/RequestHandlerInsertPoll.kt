...
import io.quiztea.extensions.poll.insertPoll
import io.quiztea.http.executor

class RequestHandlerInsertPoll : RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    override fun handleRequest(input: APIGatewayProxyRequestEvent?, context: Context?): APIGatewayProxyResponseEvent {
        val result: String = executor.call(insertPoll, mapOf(
            "body" to (input?.body ?: ""),
